...
import jingsheng.dao.registerDao;
...
//        System.out.println(System.getProperty("user.dir"));
        //得到XML文档的流对象
        InputStream inputStream = registerImpl.class.getClassLoader().getResourceAsStream("user.xml");
    ...
    public void registe(User user) {
        ...
        //获取XML文档路径
        String path = registerImpl.class.getClassLoader().getResource("user.xml").getPath();
