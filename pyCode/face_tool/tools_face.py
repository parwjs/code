...
class Window(QWidget):
    def __init__(self,parent=None):
        ...
        self.fileText.setText('请输入图片路径')
        self.fileText.setFixedSize(130,30)
        ...
        self.pathPushButton.clicked.connect(self.setBrowserPath)
        ...
        self.genderText.setFixedSize(80,30)
        ...
        self.ageText.setFixedSize(80,30)
        ...
        self.beautyText.setFixedSize(80,30)
    ...
    def start(self):
        ...
        if results['error_msg'] == 'SUCCESS':
            ...
            if self.gender == 'male':
                ...
                self.gender = '女'
            print(str(self.beauty),self.gender,self.age)
